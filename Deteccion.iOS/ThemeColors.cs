...
namespace Deteccion.iOS
 {
	internal class ThemeColors : ThemeColorsBase
	{
		private readonly static Dictionary<string, Color> _themeColors = new Dictionary<string, Color>
		{
			...
			{ "AccentColor", Color.FromHex("#2382A8") },
			{ "BaseTextColor", Color.FromHex("#4C5666") },
			{ "ListViewSelectedItemBackgroundColor", Color.FromHex("#11000000") },
			{ "SplashBackgroundColor", Color.FromHex("#2382A8") },
			{ "BrandBlockTextColor", Color.FromHex("#FFFFFF") },
			{ "BrandBlockBackgroundColor", Color.Transparent },
			{ "NavigationBarStartBackgroundColor", Color.FromHex("#005579") },
			{ "NavigationBarEndBackgroundColor", Color.FromHex("#2382A8") },
			...
			{ "DataGridCellTextColor", Color.FromHex("#4C5666") },
			...
			{ "TagItemBackgroundColor", Color.FromHex("#2382A8") },
			{ "TagItemTextColor", Color.White },
			{ "CircleActionButtonFlatBackgroundColor", Color.FromHex("#F2B342") },
			{ "CircleActionButtonFlatBorderColor", Color.FromHex("#F2B342") },
			...
			{ "BrandColor", Color.FromHex("#517322") },
			...
			{ "ComplementColor", Color.FromHex("#57b6dc") },
			...
			{ "PrimaryActionButtonStartColor", Color.FromHex("#005579") },
			{ "PrimaryActionButtonEndColor", Color.FromHex("#2382A8") },
			...
			{ "RoundedLabelBackgroundColor", Color.FromHex("#F2B342") },
			...
			{ "ChatRightBalloonBackgroundColor", Color.FromHex("#F2B342") },
