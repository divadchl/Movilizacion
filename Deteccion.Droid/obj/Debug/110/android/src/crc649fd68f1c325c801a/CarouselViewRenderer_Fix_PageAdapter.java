...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CarouselView.FormsPlugin.Android.CarouselViewRenderer_Fix+PageAdapter, Deteccion.Droid", CarouselViewRenderer_Fix_PageAdapter.class, __md_methods);
	}
	...
	public CarouselViewRenderer_Fix_PageAdapter ()
	{
		...
		if (getClass () == CarouselViewRenderer_Fix_PageAdapter.class)
			mono.android.TypeManager.Activate ("CarouselView.FormsPlugin.Android.CarouselViewRenderer_Fix+PageAdapter, Deteccion.Droid", "", this, new java.lang.Object[] {  });
	}
