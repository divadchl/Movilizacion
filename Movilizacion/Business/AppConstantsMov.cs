...
{
    public static class AppConstantsMov
    {
        /// <summary>
        ...
        /// </summary>
        public static string ListenConnectionString { get; set; } = "Endpoint=sb://mymovdec.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=uaQEBh1i/GygracqPuXPJKWIkWxzujEL6An77N6VUpA=";
        //public static string ListenConnectionString { get; set; } = "Endpoint=sb://movilizacionnotifications.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=fXGo5eXTtWEC6v9gxaSPBJSJw/0sJ7reArpyYaE16cI=";
